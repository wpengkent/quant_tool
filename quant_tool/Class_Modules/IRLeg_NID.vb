...
Dim dic_SecantOutputs As Dictionary: Set dic_SecantOutputs = New Dictionary
CalcYield = Solve_Secant(ThisWorkbook, "SolverFunc_YieldNID", dic_SecantParams, fld_Params.Yield, 0.01, dbl_Target, 0.00000000001 * fld_Params.Notional, 100, -100, dic_SecantOutputs)
